...
export const LogTemplates = {
  ...
  FACTOR_VERSION_CLOSED: 'CarbonFactor[id={id}] version closed effective_to={effectiveTo}',
  FACTOR_VERSION_NOT_FOUND: 'CarbonFactor[category={category}] no version matched: sub_type={subType} region={region} record_date={recordDate}',
