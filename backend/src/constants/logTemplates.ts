...
export const LogTemplates = {
  ...
  FACTOR_CREATE_SUCCESS: 'CarbonFactor[id={id}] create success category={category} region={region} effective_from={effectiveFrom}',
  FACTOR_CREATE_FAILED: 'CarbonFactor[id={id}] create failed: {field} {reason}',
  FACTOR_VERSION_RESOLVED: 'CarbonFactor[id={id}] version resolved category={category} region={region} effective_from={effectiveFrom} record_date={recordDate}',
  FACTOR_VERSION_MISSING: 'CarbonFactor[id={id}] version missing category={category} sub_type={subType} region={region} record_date={recordDate}',
