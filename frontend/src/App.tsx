...
import { AuditOutlined, BarChartOutlined, CloudServerOutlined, FlagOutlined, LogoutOutlined, OrderedListOutlined, TeamOutlined, UserOutlined } from '@ant-design/icons';import { useAuthStore } from './stores/authStore';
...
const navItems = [
  ...
  { key: '/factors', icon: <CloudServerOutlined />, label: '因子', admin: true },
