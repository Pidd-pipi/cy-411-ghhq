...
import { AuditOutlined, BarChartOutlined, DeploymentUnitOutlined, FlagOutlined, LogoutOutlined, OrderedListOutlined, TeamOutlined, UserOutlined } from '@ant-design/icons';
...
const navItems = [
  ...
  { key: '/factors', icon: <DeploymentUnitOutlined />, label: '因子', admin: true },
